...
'-----------------------------------------------------
' 描述: Asp无组件上传带进度条
' 作者: 宝玉(http://blog.joycode.com/dotey)
' 链接: 开放实验室(http://www.openlab.net.cn), 博客堂(http://blog.joycode.com), 博客园(http://www.cnblogs.com), 无忧脚本(http://www.51js.com)
' 版本: 1.0
' 版权: 本作品可免费使用，但是请勿移除版权信息
' 下载: http://www.webuc.net/MyProject/upload/upload.rar
' 推荐: China Community Server(http://www.CommunityServer.cn/)，一个开源的Asp.Net社区系统，包含论坛、Blog、相册和留言版等程序
'-----------------------------------------------------
...
Class DoteyUpload
	...
	Private Function GetFileExt(FullPath)
		...
		if pos>0 then GetFileExt = Mid(FullPath, pos+1)
	End Function
