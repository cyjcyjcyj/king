...
rsgly.open"select * from xw",cn,1,3
...
<table class="tableBorder" width="96%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td height="20"  align="center" bgcolor="#E8F1FF"><span class="style1"> </span>
      <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center"><%for k=1 to rsall.recordcount%><span class="style1"><a href=xwlb.asp?xwlb_id=<%=rsall("id")%>><%=rsall("xwlb")%></a></span>&nbsp;&nbsp;&nbsp;&nbsp;<%rsall.movenext
		  next%></td>
...
<table width="96%"  border="0" align="center" cellpadding="0" cellspacing="8">
  <tr>
    <td align="center"><% 
	if pages>1 then
	response.Write"<a href=xw_list.asp?pages="&pages-1&">前一页</a>&nbsp;"
	else
	response.Write"前一页&nbsp;"
	end if
	...
	for i=start to rsgly.pagecount 
	 ...
	 response.Write"&nbsp;"&i 
	  ...
	  if i<start+11 then
	  response.Write"&nbsp;<a href=xw_list.asp?pages="&i&">"&i&"</a>"
	  else
	  exit for
	 end if
	 end if
	 next 
	 if pages<rsgly.pagecount then
	 response.Write"&nbsp;<a href=xw_list.asp?pages="&pages+1&">下一页</a>"
	 else
	 response.Write"&nbsp;下一页"
	 end if
	 %></td>
...
sub delfeedback()
	...
	response.write "location.href='xw_list.asp';"
