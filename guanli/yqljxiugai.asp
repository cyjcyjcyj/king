...
rsgly.open"select * from yqlj where id="&id,cn,1,3%>
<title>管理页面</title>
...
<form name="form1" method="post" action="yqlj_xiugai.asp?id=<%=id%>">
        ...
        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
          <tr bgcolor="#E8F1FF">
            ...
            <td width="80%" style="PADDING-LEFT: 10px"><span class="TableRow2">
              <input name="wzmc" type="text" class="kuang" id="yhm4" value="<%=rsgly("wzmc")%>" size="50">
            </span></td>
          </tr>
          <tr bgcolor="#E8F1FF">
            <td width="20%" align="right">网站logo：</td>
            <td width="80%" style="PADDING-LEFT: 10px"><span class="TableRow2">
              <input name="ljlogo" type="text" class="kuang" id="mm4" value="<%=rsgly("ljlogo")%>" size="80">
            </span> </td>
          </tr> <tr bgcolor="#E8F1FF">
            <td width="20%" align="right">网站网址：</td>
            <td width="80%" style="PADDING-LEFT: 10px"><span class="TableRow2">
              <input name="wzwz" type="text" class="kuang" id="mm4" value="<%=rsgly("wzwz")%>" size="80">
            </span> </td>
          </tr><tr bgcolor="#E8F1FF">
            <td width="20%" align="right">是否是图片链接：</td>
            <td width="80%" style="PADDING-LEFT: 10px"><span class="TableRow2">
              <select name="sfstplj" id="sfstplj">
			   <option value="<%=rsgly("sfstplj")%>"><%=rsgly("sfstplj")%></option>
                <option>是</option>
                <option>否</option>
              </select>
            </span> </td>
