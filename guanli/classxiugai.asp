...
rsgly.open"select * from class where id="&id,cn,1,3%>
<title>管理页面</title>
...
<form name="form1" method="post" action="class_xiugai.asp?id=<%=id%>">
  <table class="tableBorder" width="96%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      <td  align="center" background="images/admin_bg_1.gif" height="25"><span class="style1">产品类别修改</span></td>
    </tr>
    <tr>
      <td valign="top">
        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
          <tr bgcolor="#E8F1FF">
            ...
            <td width="80%" style="PADDING-LEFT: 10px"><span class="TableRow2">
              <input name="yjfl" type="text" class="kuang" id="yhm4" value="<%=rsgly("xxlb")%>">
            </span></td>
          </tr><tr bgcolor="#E8F1FF">
            <td width="20%" align="right"><span class="TableRow2">英文产品类别</span>：</td>
            <td width="80%" style="PADDING-LEFT: 10px"><span class="TableRow2">
              <input name="enyjfl" type="text" class="kuang" id="yhm4" value="<%=rsgly("enxxlb")%>">
            </span></td>
          </tr>
          <tr bgcolor="#E8F1FF">
            <td height="30"></td>
