...
<body>
<form name="form" method="post" action="dlb_add.asp">
  <table class="tableBorder" width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
    <tr>
      <td  align="center" background="images/admin_bg_1.gif" height="25"><span class="style1">净化工程分类添加</span></td>
    </tr>
    <tr>
      <td valign="top">
        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
          <tr bgcolor="#E8F1FF">
            ...
            <input name="dlb" type="text" id="dlb" size="40">
</span></td>
          </tr> <tr bgcolor="#E8F1FF">
            <td width="16%" align="right">英文分类名称：</td>
            <td style="PADDING-LEFT: 10px"><span class="TableRow2">
            <input name="endlb" type="text" id="endlb" size="40">
</span></td>
          </tr>
          <tr bgcolor="#E8F1FF">
            <td height="30"></td>
