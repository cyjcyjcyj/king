...
rsgly.open"select * from jhxlb where id="&id,cn,1,3
...
<form name="form1" method="post" action="jhxlb_xiugai.asp?id=<%=id%>">
      ...
      <td valign="top">
        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
          <tr bgcolor="#E8F1FF">
            ...
            <td width="20%" align="right"><span class="TableRow2">英文新闻类别</span>：</td>
            <td width="80%" style="PADDING-LEFT: 10px"><span class="TableRow2">
              <input name="enxlb" type="text" class="kuang" id="yhm4" value="<%=rsgly("enxlb")%>">
            </span></td>
          </tr>
          <tr bgcolor="#E8F1FF">
            <td height="30"></td>
