...
<body>
<form name="myform" method="post" action="dckt_add.asp">
  <table class="tableBorder" width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
    <tr>
      <td  align="center" background="images/admin_bg_1.gif" height="25"><span class="style1">项目内容</span></td>
    </tr>
    <tr>
      <td valign="top">
        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
          <tr bgcolor="#E8F1FF">
            ...
            <td width="80%" style="PADDING-LEFT: 10px"><input name="cpmc" type="text" id="cpmc" size="50"></td>
          </tr>
          <tr bgcolor="#E8F1FF">
          ...
          <tr bgcolor="#E8F1FF">
            ...
            <td style="PADDING-LEFT: 10px"><input name="tpdz1" type="text" id="tpdz1" value="images/upfile/lyx.jpg" size="50">
...
<select name="classid" id="classid">
  <option value="" selected>请选择二级栏目</option>
</select>
</span> </td>
          </tr>
          <tr bgcolor="#E8F1FF">
