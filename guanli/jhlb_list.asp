...
<table class="tableBorder" width="96%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td  align="center" background="images/admin_bg_1.gif" height="25"><span class="style1">产品类别列表[<a href="dlbadd.asp"><font color="#FFFFFF">添加大类别</font></a>] [<a href="jhxlbadd.asp"><font color="#FFFFFF">添加小类别</font></a>]</span></td>
  </tr>
  <tr>
      ...
      <tr bgcolor="#E8F1FF">
        <td colspan="5" align="center"><table width="100%" height="61"  border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
            ...
            <td width="50%"> <a href="dlbxiugai.asp?id=<%=rsgly("id")%>">修改</a> <a href="dlb_del.asp?id=<%=rsgly("id")%>">删除</a></td>
		  </tr>
          <tr>
			...
			for j=1 to rsxlb.recordcount%>
              <tr>
                ...
                <td width="49%"><a href="jhxlbxiugai.asp?id=<%=rsxlb("id")%>">修改</a> <a href="jhxlb_del.asp?id=<%=rsxlb("id")%>">删除</a></td>
              </tr>
			  <%rsxlb.movenext
			  next%>
            </table>
