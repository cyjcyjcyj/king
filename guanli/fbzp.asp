...
<table height="314" border="0" cellpadding="0" cellspacing="0"  class=tableBorder>
  <tr>
    <td  background=images/top_bg.gif height="25"><div align="center" style="color: #000000; font-weight: bold;"><strong>发布招聘信息</strong></div></td>
  </tr>
  <tr>
    <form method="post" action="zpgl_add.asp">
      ...
      <td><div align="center">
          <table width="100%" height="321" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#f1f3f5">
            <tr>
              ...
              <td width="81%">              <input name="zpdx" type="text" class="inputtext" id="zpdx" size="30" maxlength="30"></td>
            </tr>
            <tr>
              <td height="25">
                <div align="center">招聘人数</div></td>
              <td ><input name="zprs" type="text" class="inputtext" id="zprs" size="5" maxlength="30">
                人</td>
            </tr>
            <tr>
              <td height="25">
              ...
              <td >
                <input name="gzdd" type="text" class="inputtext" id="gzdd" size="30" maxlength="50">
              </td>
            </tr>
            <tr>
              <td height="25"><div align="center">工资待遇</div></td>
              <td>
                <input name="gzdy" type="text" class="inputtext" id="gzdy" size="30" maxlength="50"></td>
            </tr>
            <tr>
              <td height="25">
                <div align="center">发布日期</div></td>
              <td><input name="fbsj" type="text" class="inputtext" id="fbsj" size="30" maxlength="50"> </td>
            </tr>
            <tr>
              <td height="25"><div align="center">有效期限</div></td>
              <td ><input name="yxqx" type="text" class="inputtext" id="yxqx" size="5" maxlength="30">
                天</td>
            </tr>
            <tr>
              <td height="25"><div align="center">招聘要求</div></td>
              <td>
                <textarea name="zpyq" cols="50" rows="5" class="inputtext" id="zpyq"></textarea></td>
            </tr>
            <tr>
