...
<body>
<form name="form" method="post" action="jhxlb_add.asp">
  <table class="tableBorder" width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
    <tr>
      <td  align="center" background="images/admin_bg_1.gif" height="25"><span class="style1">新闻分类添加</span></td>
    </tr>
    <tr>
      <td valign="top">
        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
          <tr bgcolor="#E8F1FF">
            ...
            <td style="PADDING-LEFT: 10px"><span class="TableRow2">
            <input name="enxlb" type="text" id="enxlb" size="40">
</span></td>
          </tr>
          <tr bgcolor="#E8F1FF">
            <td height="30"></td>
