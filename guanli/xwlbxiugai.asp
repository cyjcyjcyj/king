...
rsgly.open"select * from xwlb where id="&id,cn,1,3%>
<title>管理页面</title>
...
<form name="form1" method="post" action="xwlb_xiugai.asp?id=<%=id%>">
        ...
        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
          <tr bgcolor="#E8F1FF">
            ...
            <td width="80%" style="PADDING-LEFT: 10px"><span class="TableRow2">
              <input name="yjfl" type="text" class="kuang" id="yhm4" value="<%=rsgly("xwlb")%>">
            </span></td>
          </tr>
          <tr bgcolor="#E8F1FF">
            <td height="30"></td>
