...
<TR>
  <TD>取保存的文件名，如果不要带路径的填充下拉框，可以在下面的表单项加入onchange事件</TD>
  <TD><input type="text" name="d_savefilename"></TD>
</TR>
<TR>
  <TD>取保存的文件名（带路径），使用带路径的填充下拉框</TD>
  <TD><input type="text" name="d_savepathfilename"></TD>
</TR>
<TR>
  <TD>1</TD>
  <TD><input name="textfield1" type="text" id="textfield1">
    <input type="button" name="Button" value="选择图片" onClick='selectpic("d_savepathfilename","textfield1")'></TD>
</TR>
<TR>
  <TD>2</TD>
  <TD><input type="text" name="textfield2">
    <input type="button" name="Button2" value="选择图片" onClick='selectpic("d_savepathfilename","textfield2")'></TD>
</TR>
<TR>
  <TD>&nbsp;</TD>
  <TD><select name="d_picture" size=1><option value=''>无</option></select></TD>
</TR>
<TR>
	<TD>编辑内容：</TD>
	<TD>
...
<TR>
	...
	<INPUT type=button name=b3 value="查看源文件" onClick="location.replace('view-source:'+location)">	</TD>
</TR>
<TR>
	<TD>取到内容：</TD>
...
<TR>
	...
	<INPUT type=button name=b10 value="尾部追加" onClick="eWebEditor1.appendHTML('This is Append Function!')">	</TD>
</TR>
</TABLE>
</FORM>
