...
rsyjfl.open"select * from class",cn,1,3%>
<title>管理页面</title>
...
<table class="tableBorder" width="96%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td  align="center" background="images/admin_bg_1.gif" height="25"><span class="style1">下载分类列表</span></td>
  </tr>
  <tr>
    <td valign="top">    <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
      ...
      <tr align="center" bgcolor="#E8F1FF">
        ...
        <td height="15"><span class="TableRow2"><%=rsyjfl("xxlb")%></span></td>
        <td height="15"><span class="TableRow2"><%=rsyjfl("enxxlb")%></span></td>
        <td height="15"><span class="TableRow1"><span class="TableRow2"><span class="BodyTitle"><a href="classxiugai.asp?id=<%=rsyjfl("id")%>">修改</a></span></span></span></td>
        
        <td height="15"><span class="TableRow2"><span class="BodyTitle"><a href="class_del.asp?id=<%=rsyjfl("id")%>" onclick="{if(confirm('该操作不可恢复！\n\n确实删除选定的项目？\n注意！一旦删除此项目下的下载项目也将被删除')){this.document.Prodlist.submit();return true;}return false;}">删除</a></span></span></td>
      </tr>
      <%rsyjfl.movenext
next
rsyjfl.close
